...
final class RMEpisodeDetailView: UIView {
    ...
    // Create the var viewModel of type RMEpisodeDetailViewViewModel
...
// Create the extension RMEpisodeDetailView Here
extension RMEpisodeDetailView {
    ...
    // Create the func createCharacterLayout which is of type NSCollectionLayoutSection
    func createCharacterLayout()->NSCollectionLayoutSection{
        ...
        let group = NSCollectionLayoutGroup.horizontal(
            ...
            // If it is iPhone, it will be [item,item], Otherwise, it will be [item,item,item,item]
            // which is MacOS or Other Devices, which is 4 items
