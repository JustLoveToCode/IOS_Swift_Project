...
// Create the RMLocationTableViewCell that inherit from UITableViewCell Here
final class RMLocationTableViewCell: UITableViewCell {
    static let cellIdentifier = "RMLocationTableViewCell"
    
    // Create the var nameLabel of type UILabel
    ...
    // Create the var typeLabel of type UILabel
    ...
    // Create the var dimensionLabel of type UILabel
    ...
    private func addConstraints(){
        // Creating the constraint for the Different Labels Here
